define(["require", "exports", "./telemetry", "./lazy-module", "./function-wrapper"], function (require, exports, telemetry_1, lazy_module_1, function_wrapper_1) {
    ...
    exports.load = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildLoadMetadata(options), function () { return instrumentRecordInstance(getNsRecord().load(options)); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildLoadMetadata(options), function () { return getNsRecord().load.promise(options).then(function (recordInstance) { return instrumentRecordInstance(recordInstance); }); }); });
    ...
    exports.copy = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildCopyMetadata(options), function () { return instrumentRecordInstance(getNsRecord().copy(options)); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildCopyMetadata(options), function () { return getNsRecord().copy.promise(options).then(function (recordInstance) { return instrumentRecordInstance(recordInstance); }); }); });
    exports.transform = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildTransformMetadata(options), function () { return instrumentRecordInstance(getNsRecord().transform(options)); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildTransformMetadata(options), function () { return getNsRecord().transform.promise(options).then(function (recordInstance) { return instrumentRecordInstance(recordInstance); }); }); });
    exports.submitFields = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildSubmitFieldsMetadata(options), function () { return getNsRecord().submitFields(options); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildSubmitFieldsMetadata(options), function () { return getNsRecord().submitFields.promise(options); }); });
    var deleteRecordBase = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildDeleteMetadata(options), function () { return getNsRecord().delete(options); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildDeleteMetadata(options), function () { return getNsRecord().delete.promise(options); }); });
