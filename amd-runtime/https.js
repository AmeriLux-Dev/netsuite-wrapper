define(["require", "exports", "./telemetry", "./lazy-module", "./function-wrapper"], function (require, exports, telemetry_1, lazy_module_1, function_wrapper_1) {
    ...
    exports.get = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('get', 'HTTPS GET request', options), function () { return getNsHttps().get(options); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('get', 'HTTPS GET request', options), function () { return getNsHttps().get.promise(options); }); });
    var deleteRequestBase = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('delete', 'HTTPS DELETE request', options), function () { return getNsHttps().delete(options); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('delete', 'HTTPS DELETE request', options), function () { return getNsHttps().delete.promise(options); }); });
    exports.delete = deleteRequestBase;
    exports.post = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('post', 'HTTPS POST request', options), function () { return getNsHttps().post(options); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('post', 'HTTPS POST request', options), function () { return getNsHttps().post.promise(options); }); });
    exports.put = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('put', 'HTTPS PUT request', options), function () { return getNsHttps().put(options); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('put', 'HTTPS PUT request', options), function () { return getNsHttps().put.promise(options); }); });
    exports.request = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('request', 'HTTPS request', options), function () { return getNsHttps().request(options); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('request', 'HTTPS request', options), function () { return getNsHttps().request.promise(options); }); });
    exports.requestRestlet = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('requestRestlet', 'HTTPS RESTlet request', options), function () { return getNsHttps().requestRestlet(options); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('requestRestlet', 'HTTPS RESTlet request', options), function () { return getNsHttps().requestRestlet.promise(options); }); });
    exports.requestSuitelet = (0, function_wrapper_1.wrapFunction)(function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('requestSuitelet', 'HTTPS Suitelet request', options), function () { return getNsHttps().requestSuitelet(options); }); }, function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('requestSuitelet', 'HTTPS Suitelet request', options), function () { return getNsHttps().requestSuitelet.promise(options); }); });
    exports.requestSuiteTalkRest = (function (options) { return (0, telemetry_1.runWrappedOperation)(buildRequestMetadata('requestSuiteTalkRest', 'HTTPS SuiteTalk REST request', options), function () { return getNsHttps().requestSuiteTalkRest(options); }); });
});
